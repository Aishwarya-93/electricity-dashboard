...
/* ========================= */
/* --- FIX FADED NORMAL TEXT --- */

/* All normal text (st.write, st.text, etc.) */
...
/* Stronger visibility for important values */
strong {
    ...
    with tab4:
        ...
        fig2.update_layout(
            ...
            legend=dict(
                ...
                bgcolor="rgba(0,0,0,0.5)"   # optional background for clarity
            )
        )
        ...
        fig2.add_scatter(
            ...
            name='⚠️ Anomalies',
            marker=dict(
                color='red',        # 🔥 keep your original red
                size=10,
